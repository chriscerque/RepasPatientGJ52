...
public final class C_MSG {
    ...
    public static final String MSG_NUM_SECU_LNG_MIN = "La longueur du numéro de sécu doit être de 5 caractères minimum!";
    public static final String MSG_PATIENT_NOM_LNG = "Le nom doit être entre 5 et 30 caractères...";
    public static final String MSG_PATIENT_PRENOM_LNG = "Le prénom doit être entre 5 et 30 caractères...";
    public static final String MSG_DATE_REPAS_NULL = "La date de repas doit être renseignée...";
    public static final String MSG_TYPE_REPAS_NULL = "Le type de repas doit être renseigné...";
    public static final String MSG_DATE_ENTREE_NULL = "La date d'entrée doit être renseignée...";
    public static final String MSG_FM_NULL = "FacadeMetier NULL...";
    public static final String MSG_FV_NULL = "FacadeVue NULL...";
    public static final String SELECTION_PATIENT = "Veuillez sélectionner un patient: ";
    public static final String SELECTION_REPAS = "Veuillez sélectionner le repas: ";
    public static final String REPAS_AJOUT = "%s du %s ajouté à %s %s";
    public static final String PATIENT_MODIFICATION_OK = "Patient modifié avec succès!";
