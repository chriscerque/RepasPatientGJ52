package ent.etrs.pdi.blu.view.ihm;

import ent.etrs.pdi.blu.view.ihm.exceptions.IhmException;
import ent.etrs.pdi.blu.view.ihm.references.ConstantesIhm;
import ent.etrs.pdi.blu.view.ihm.references.OutilsIhm;
...
public class ConsoleIhm implements Ihm{
    ...
    public int saisirChoixMenu(String[] tabloStr) throws IhmException {
        String strMenu = OutilsIhm.construireMenu(ConstantesIhm.TITRE_MENU_DFLT, tabloStr);

        int chx = saisirEntier(strMenu, 0, tabloStr.length + 1);
        return chx;
    }
