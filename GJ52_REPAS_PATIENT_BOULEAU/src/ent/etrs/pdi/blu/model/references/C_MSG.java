...
public final class C_MSG {
    ...
    public static final String MSG_PATIENT_NOM_LG_EXCEPTION = "LA longueur nom ou prenom n'est pas comprise entre 3 & 50 carac.";
    public static final String MSG_PATIENT_SECU_LG_EXCEPTION = "LA longueur num secu n'est pas de 5 carac ou n'est pas composé de chiffres";
    public static final String MSG_PATIENT_SECU_EXCEPTION = "Le num secu n'est pas renseigné";
    ...
    public static final String MSG_REPAS_CREATION_EXCEPTION = "La sauvegarde du repas %s %s n'a pas pu être effectuée.\"";
    //AFFICH
    //public static final String AFF_PATIENT = "Patient %s %s %s " + ConstantesView.PATTERN_DATE("%d");
