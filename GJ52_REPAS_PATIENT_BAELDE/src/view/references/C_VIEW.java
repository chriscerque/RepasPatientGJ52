...
public final class C_VIEW {
    ...
    public static final String MENU_TITRE = "Repas patient";
    public static final String MENU_SORTIR = "Sortir";
    ...
    public static final String MSG_SELECTIONNER_REPAS = "Veuillez sélectionner un repas";
    public static final String MSG_SELECTIONNER_PATIENT = "Choisissez un patient";
