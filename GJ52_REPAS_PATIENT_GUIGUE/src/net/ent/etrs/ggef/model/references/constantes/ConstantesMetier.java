package net.ent.etrs.ggef.model.references.constantes;
...
// public static final int MAJORITE = 18;
    ...
    public static final String MSG_PATIENT_NUM_SECU_NULL = "Le numéro de sécurité sociale dois être renseigné";
    public static final String MSG_PATIENT_NUM_SECU_LONGUEUR = "le numéro de sécurité sociale doit avoir une longueur de 5 caractères";
    public static final String MSG_PATIENT_NOM_NULL = "le nom du patient doit être renseigné" ;
    public static final String MSG_PATIENT_NOM_LONGUEUR = "le nom du patient doit avoir une longueur comprise entre 3 et 50 caractères";
    public static final String MSG_PATIENT_PRENOM_LONGUEUR = "le prénom du patient doit avoir une longueur comprise entre 3 et 50 caractères";
    public static final LocalDate DATE_JOUR = LocalDate.now();
    public static final String MSG_PATIENT_DATE_FUTURE = "La date d'entrée ne peut pas être dans le futur";
