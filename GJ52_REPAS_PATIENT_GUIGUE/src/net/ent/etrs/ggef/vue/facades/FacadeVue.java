...
public interface FacadeVue {
     ...
     * @throws DisplayException si une erreur est survenue durant la saisie.
     */
    Patient saisirPatient() throws DisplayException;
...
//    void afficherRepas(Patient c);
     ...
     * @throws DisplayException si une erreur est survenue durant la saisie.
     */
    Patient modifierPatient(Patient patient) throws DisplayException;
