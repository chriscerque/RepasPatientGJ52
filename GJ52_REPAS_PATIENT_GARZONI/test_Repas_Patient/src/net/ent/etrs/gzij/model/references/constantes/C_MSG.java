 ...
 *
 */
package net.ent.etrs.gzij.model.references.constantes;
...
public final class C_MSG {
    ...
    public static final String MSG_PATIENT_PRENOM_TAILLE_INCORRECT = "Le prénom doit être compris entre 5 et 30 caractères.";
    public static final String MSG_PATIENT_NOM_TAILLE_INCORRECT = "Le nom doit être compris entre 5 et 30 caractères.";
    public static final String MSG_PATIENT_NUMSECU_TAILLE_INCORRECT = "Le numéro de sécurité doit être de 5 caractères.";
    public static final String MSG_PATIENT_NUMSECU_EXCEPTION = "Le numéro de sécurité doit être de 5 caractères.";
