...
import net.ent.etrs.gzij.model.dao.commons.GenericMemDao;
...
public class AbstractPatientDao extends GenericMemDao<Patient, String> implements IPatientMemDao {
...
-----------------------*/
    ...
    public void init() {
        try {
            ...
            Patient haddock = EntitiesFactory.fabriquerPatient("12455", "HADDOCK", "Archibald", LocalDate.of(1970, Month.APRIL, 1));
            Patient tintin = EntitiesFactory.fabriquerPatient("12348", "TINTIN", "Mar", LocalDate.of(1970, Month.FEBRUARY, 10));
            Patient tournesol = EntitiesFactory.fabriquerPatient("12775", "TOURNESOL", "Tryphon", LocalDate.of(1970, Month.MAY, 20));
