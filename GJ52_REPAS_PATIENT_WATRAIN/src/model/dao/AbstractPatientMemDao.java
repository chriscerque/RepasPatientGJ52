...
public abstract class AbstractPatientMemDao extends DaoGeneric<Patient, String> implements IPatientMemDao {

	private IRepasMemDao repasMemDao = new RepasMemDao();
	//<editor-fold desc="Constructeurs">
	public AbstractPatientMemDao() {
	}
	//</editor-fold>
	...
	public void init() {
		...
		} catch (DaoException | PatientException | RepasConstructionException | PatientConstructionException | RegimeAlimentaireException e) {
			System.err.println(e.getMessage()); //TODO throws further
		}
	}
