...
public abstract class AbstractRepasMemDao extends DaoGeneric<Repas, String> implements IRepasMemDao {

	//<editor-fold desc="Constructeurs">
	public AbstractRepasMemDao() {
	}
	//</editor-fold>
	...
	public void init() {
		...
		} catch (DaoException | RegimeAlimentaireException | RepasConstructionException e) {
