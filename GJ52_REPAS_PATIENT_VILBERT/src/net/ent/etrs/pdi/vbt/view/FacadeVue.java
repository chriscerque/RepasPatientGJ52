package net.ent.etrs.pdi.vbt.view;
...
public interface FacadeVue {
     ...
     * @throws VueException si une erreur est survenue durant la saisie.
     */
...
//    void afficherRepas(Patient c);
     ...
     * @throws VueException si une erreur est survenue durant la saisie.
     */
    Patient modifierPatient(Patient patient) throws VueException;
