...
public class JPanelIhmImpl implements Ihm {
    ...
    public String saisir(String invite) {
        //Affiche une boîte de dialogue avec un message d'invitation à saisir
    ...
    public boolean saisirBooleen(String invite) {
        //Initialise le choix
        int choix;
        //Affiche une boîte de dialogue Oui ou Non
        do {
            choix = JOptionPane.showConfirmDialog(null, invite);
            if (choix!=0 && choix!=1) {
                afficher("Vous devez faire un choix.");
            }
