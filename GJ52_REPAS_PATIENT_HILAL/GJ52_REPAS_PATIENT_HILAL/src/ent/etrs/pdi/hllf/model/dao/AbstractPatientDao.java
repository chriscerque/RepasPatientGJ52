...
public abstract class AbstractPatientDao implements IPatientMemDao
{
    ...
    public AbstractPatientDao() {
        this.repasMemDao = DaoFactory.fabriquerRepasDao();
    }
    ...
    public void init() throws DaoException {
        try {
            ...
            Patient haddock = EntitiesFactory.fabriquerPatient("12456", "HADDOCK", "Archibald", LocalDate.of(1970, Month.APRIL, 1));
...
//            miney.ajouterRegimeAlimentaire(RegimeAlimentaire.VEGAN);
        ...
        } catch (PatientConstructionException | RepasException | PatientException | RepasConstructionException | DaoException e) {
